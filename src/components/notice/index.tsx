...
const during = (message: string) =>
  Math.min(8000, Math.max(3000, message.length * 200))
...
function NoticeFunc() {
  ...
  successNotice = (message: string) => {
    enqueueSnackbar(message, {
      variant: 'success',
      autoHideDuration: during(message),
    })
  }
...
export { NoticeProvider, successNotice, infoNotice, warningNotice, errorNotice }
